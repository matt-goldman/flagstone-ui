...
/// <summary>
/// Represents a customizable editor control with support for various visual and behavioral properties.
/// </summary>
/// <remarks>The <see cref="FsEditor"/> control extends the functionality of a standard editor field by providing
/// additional customization options such as border color, border width, corner radius, and text alignment. It also
/// supports events for text changes and completion, making it suitable for scenarios requiring enhanced multi-line user input
...
public partial class FsEditor : ContentView
{
	public FsEditor()
	{
		InitializeComponent();
	...
	/// </summary>
	/// <remarks>This property determines the brush used for the border of the <see cref="FsEditor"/> control.
	...
	{
		if (bindable is FsEditor editor && newValue is double value)
		{
			editor.BorderShape = new RoundRectangle
			{
				CornerRadius = value
			};
		}
	...
	/// <summary>
	/// Identifies the bindable property for the placeholder text of the editor.
	/// </summary>
	/// <remarks>This property is used to define the placeholder text displayed in the editor when no value is
	...
	/// </summary>
	/// <remarks>This property allows binding to the text color of the editor. The default value is <see
	...
	/// </summary>
	/// <remarks>This property allows binding to the background brush of the <see cref="FsEditor"/> control. The
	...
	/// <summary>
	/// Identifies the bindable property for the horizontal text alignment of the editor.
	/// </summary>
	/// <remarks>This property determines the horizontal alignment of the text within the editor.  The default value
	...
	/// </summary>
	/// <remarks>The default value for this property is <see cref="TextAlignment.Start"/>. This property supports
	...
	/// </summary>
	/// <remarks>This property is used to define the keyboard type for the <see cref="FsEditor"/> control.  The
	...
	/// </summary>
	/// <remarks>This property represents the padding applied to the <see cref="FsEditor"/> control.  The default
	...
	#region AutoSizeProperty
	/// <summary>
	/// Identifies the AutoSize bindable property.
	/// </summary>
	/// <remarks>This property determines whether the editor automatically adjusts its height based on content.
	/// The default value is <see cref="EditorAutoSizeOption.Disabled"/>.</remarks>
	...
	/// <summary>
	/// Gets or sets whether the editor automatically adjusts its height based on content.
	/// </summary>
	...
	/// <summary>
	/// Identifies the MaxLength bindable property.
	/// </summary>
	/// <remarks>This property specifies the maximum number of characters allowed in the editor.
	/// The default value is int.MaxValue (no limit).</remarks>
	...
	/// <summary>
	/// Gets or sets the maximum number of characters allowed in the editor.
	/// </summary>
	...
	/// </summary>
	/// <remarks>This property determines whether the editor is read-only.
	...
	private void BorderlessEditor_Unfocused(object sender, FocusEventArgs e)
	{
